 ...
 */
export interface IBasicSurfaceOptions<T extends Lookup<InstanceProvider<Instance>>, U extends Lookup<Camera>, V extends Lookup<EventManager> | EventManager[], W extends Lookup<BaseResourceOptions>> {
    ...
    scenes(resources: W, providers: T, cameras: U, managers: V): Lookup<BasicSurfaceSceneOptions> | BasicSurfaceSceneOptions[];
 ...
 */
export declare class BasicSurface<T extends Lookup<InstanceProvider<Instance>>, U extends Lookup<Camera>, V extends Lookup<EventManager> | EventManager[], W extends Lookup<BaseResourceOptions>> {
