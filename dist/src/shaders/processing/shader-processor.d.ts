...
export declare type ProcessShaderImportResults = {
    fs: OutputFragmentShader;
    vs: string;
...
export declare class ShaderProcessor {
     ...
     * system.
     */
    process<T extends Instance, U extends ILayerProps<T>>(layer: Layer<T, U>, shaderIO: IShaderInitialization<T>, fragmentShaders: OutputFragmentShader, shaderDeclarations: ShaderDeclarationStatementLookup, ioExpansion: BaseIOExpansion[], transforms: BaseShaderTransform[], sortIO: BaseIOSorting): IShaderProcessingResults<T> | null;
    /**
