 ...
 * world.
 */
export declare function createLayer2Din3D<TInstance extends Instance, TProps extends ILayerProps<TInstance>>(axis2D: Axis2D, classType: ILayerConstructable<TInstance, TProps> & {
    defaultProps: TProps;
