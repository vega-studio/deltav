 ...
 */
export declare function diffUnitQuat(q1: Quaternion, q2: Quaternion, out?: Quaternion): Quaternion;
/**
 ...
 * the orientation.
 */
export declare function matrix3x3FromUnitQuatModel(q: Quaternion, m?: Mat3x3): Mat3x3;
/**
 * Produces a transform matrix from a returned unit quaternion. This is a matrix
 * that is from a 'models' perspective where the model orients itself to match
 * the orientation.
 ...
 */
export declare function matrix3x3FromUnitQuatView(q: Quaternion, m?: Mat3x3): Mat3x3;
/**
 * Produces a transform matrix from a returned unit quaternion. This is a matrix
 * that is from a 'views' perspective where the world orients to match the view.
 */
 ...
 * sz = length4(row2);
 */
export declare function decomposeRotation(mat: Mat4x4, sx: number, sy: number, sz: number, q?: Quaternion): Vec4;
 ...
 */
export declare function rotateVectorByUnitQuat(v: Vec3, q: Quaternion, out?: Vec3): Vec3;
/**
