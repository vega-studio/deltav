...
export declare class ResourceRouter {
     ...
     */
    request<TInstance extends Instance, TLayer extends Layer<TInstance, TLayerProps>, TLayerProps extends ILayerProps<TInstance> = TLayer["props"], TResourceType extends IResourceType = IResourceType>(layer: TLayer, instance: TInstance, resource: TResourceType, context?: IResourceContext): InstanceIOValue;
    /**
...
export declare const DEFAULT_RESOURCE_ROUTER: ResourceRouter;
