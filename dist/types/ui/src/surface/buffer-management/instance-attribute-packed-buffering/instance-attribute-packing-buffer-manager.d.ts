...
export type IInstanceAttributePackingBufferLocationGroup = IBufferLocationGroup<IInstanceAttributePackingBufferLocation>;
/**
 * This manages instances in how they associate with buffer data for an instanced attribute strategy that is
 * packed tightly.
 */
export declare class InstanceAttributePackingBufferManager<TInstance extends Instance, TProps extends ILayerProps<TInstance>> extends BufferManagerBase<TInstance, TProps, IInstanceAttributePackingBufferLocation> {
     ...
     */
    getBufferLocations(instance: TInstance): IInstanceAttributePackingBufferLocationGroup;
    /**
