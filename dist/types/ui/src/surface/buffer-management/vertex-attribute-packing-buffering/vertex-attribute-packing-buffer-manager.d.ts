 ...
 */
export interface IVertexAttributePackingBufferLocation extends IBufferLocation {
}
/** Represents the Location Groupings for Instance attribute Buffer locations */
export type IVertexAttributePackingBufferLocationGroup = IBufferLocationGroup<IVertexAttributePackingBufferLocation>;
/**
 * This manages instances in how they associate with buffer data for an instanced attribute strategy that is
 * packed tightly.
 */
export declare class VertexAttributePackingBufferManager<TInstance extends Instance, TProps extends ILayerProps<TInstance>> extends BufferManagerBase<TInstance, TProps, IVertexAttributePackingBufferLocation> {
     ...
     */
    getBufferLocations(instance: TInstance): IVertexAttributePackingBufferLocationGroup;
    /**
