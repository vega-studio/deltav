...
import { BaseShaderIOInjection, ShaderIOHeaderInjectionResult } from "../../shaders/processing/base-shader-io-injection.js";
import { MetricsProcessing } from "../../shaders/processing/metrics-processing.js";
import type { IIndexBuffer, IInstanceAttribute, IUniform, IVertexAttribute, ShaderInjectionTarget } from "../../types.js";
...
export declare abstract class BaseIOExpansion extends BaseShaderIOInjection {
     ...
     */
    processHeaderInjection<TInstance extends Instance, TLayerProps extends ILayerProps<TInstance>>(_target: ShaderInjectionTarget, _declarations: Map<string, string>, _layer: Layer<TInstance, TLayerProps>, _metrics: MetricsProcessing, _vertexAttributes: IVertexAttribute[], _instanceAttributes: IInstanceAttribute<TInstance>[], _uniforms: IUniform[]): ShaderIOHeaderInjectionResult;
    /**
     ...
     *                about buffering strategies etc.
     */
    processAttributeDestructuring<TInstance extends Instance, TLayerProps extends ILayerProps<TInstance>>(_layer: Layer<TInstance, TLayerProps>, _declarations: Map<string, string>, _metrics: MetricsProcessing, _vertexAttributes: IVertexAttribute[], _instanceAttributes: IInstanceAttribute<TInstance>[], _uniforms: IUniform[]): string;
}
