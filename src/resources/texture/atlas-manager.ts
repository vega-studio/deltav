...
import { ColorAtlasResourceRequest } from "./color-atlas-resource-request";
...
export class AtlasManager {
  ...
  private async loadImage(
    ...
    if (resource instanceof ImageAtlasResourceRequest) {
    ...
    } else if (resource instanceof LabelAtlasResourceRequest) {
    ...
    } else if (resource instanceof ColorAtlasResourceRequest) {
