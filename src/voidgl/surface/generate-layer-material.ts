...
export function generateLayerMaterial(layer: Layer<any, any, any>, vs: string, fs: string, layerUniforms: IUniform[], instancingUniforms: IInstancingUniform[]): Three.RawShaderMaterial {
