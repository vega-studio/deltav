...
export function determinant3(mat: Mat3): number {
  return  mat[0] * mat[4] * mat[8] - mat[0] * mat[5] * mat[7] +
    mat[1] * mat[5] * mat[6] - mat[1] * mat[3] * mat[8] +
    mat[2] * mat[3] * mat[7] - mat[2] * mat[4] * mat[6];
}

export function determinant4(mat: Mat4): number {
  const m0: Mat3 = [mat[5], mat[6], mat[7], mat[9], mat[10], mat[11], mat[13], mat[14], mat[15]];
  const m1: Mat3 = [mat[4], mat[6], mat[7], mat[8], mat[10], mat[11], mat[12], mat[14], mat[15]];
  const m2: Mat3 = [mat[4], mat[5], mat[7], mat[8], mat[9], mat[11], mat[12], mat[13], mat[15]];
  const m3: Mat3 = [mat[4], mat[5], mat[6], mat[8], mat[9], mat[10], mat[12], mat[13], mat[14]];

  return mat[0] * determinant3(m0) - mat[1] * determinant3(m1) + mat[2] * determinant3(m2) - mat[3] * determinant3(m3);
}

export function affineInverse(mat: Mat4): Mat4 | null {
  const determiant = determinant4(mat);
  if (determiant === 0) return null;

  const s0 = determinant2([mat[0], mat[1], mat[4], mat[5]]);
  const s1 = determinant2([mat[0], mat[2], mat[4], mat[6]]);
  const s2 = determinant2([mat[0], mat[3], mat[4], mat[7]]);
  const s3 = determinant2([mat[1], mat[2], mat[5], mat[6]]);
  const s4 = determinant2([mat[1], mat[3], mat[5], mat[7]]);
  const s5 = determinant2([mat[2], mat[3], mat[6], mat[7]]);

  const c5 = determinant2([mat[10], mat[11], mat[14], mat[15]]);
  const c4 = determinant2([mat[9], mat[11], mat[13], mat[15]]);
  const c3 = determinant2([mat[9], mat[10], mat[13], mat[14]]);
  const c2 = determinant2([mat[8], mat[11], mat[12], mat[15]]);
  const c1 = determinant2([mat[8], mat[10], mat[12], mat[14]]);
  const c0 = determinant2([mat[8], mat[9], mat[12], mat[13]]);
...
export function Hadamard(left: Mat4, right: Mat4): Mat4 {
  return [
    // r0
    left[0] * right[0],
    // r1
